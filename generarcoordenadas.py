...
cadena1=str(lista)
cadena2=cadena1.replace('),',');').replace('Point(','(').replace('x=','').replace('y=','').replace('[(','(').replace(')]',')').replace(' ','').replace('(','').replace(')','')
print(cadena2)
...
archivocolores.write(str(listacolores).replace('),',');').replace('[(','(').replace(')]',')').replace('(','').replace(')','').replace(' ',''))
